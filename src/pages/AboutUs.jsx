        ...
        <div>
            ...
            <ContentSection>
                <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-slate-200">
                    {(content.intro?.paragraphs || []).map((paragraph, index, all) => (
                        <p
                            key={index}
                            className={`text-lg text-slate-700 leading-relaxed ${index < all.length - 1 ? 'mb-4' : ''}`}
                        >
                            {paragraph}
                        </p>
                    ))}
            ...
            <ContentSection className="py-12">
                <div className="text-center mb-10">
                    ...
                    <h2 className="text-3xl font-bold text-[#1E3A5F] mb-3">{content.meetingsSection?.heading}</h2>
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        {content.meetingsSection?.intro}
                    </p>
                </div>
            ...
            <ContentSection className="py-12">
                <div className="bg-gradient-to-br from-[#7C6A9F] to-[#1E3A5F] rounded-2xl p-8 md:p-12 text-white shadow-2xl">
                    <div className="text-center max-w-3xl mx-auto">
                        <h3 className="text-2xl font-bold mb-4">{content.unity?.heading}</h3>
